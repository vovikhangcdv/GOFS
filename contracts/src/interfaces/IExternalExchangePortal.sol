 ...
 */
interface IExternalExchangePortal {
    /**
    ...
    /**
     * @notice Exchange token0 for token1 or vice versa
    ...
    /**
     * @notice Calculate the output amount for an exchange
     * @param fromToken Address of the token to exchange from
     * @param toToken Address of the token to exchange to
     * @param amountIn Amount of fromToken to exchange
     * @return amountOut Amount of toToken that would be received
     */
